...
function listarGrid(){
    $.get('https://20.206.250.122:5187/Avaliacao/Listar')
...
function filtrarDisciplinas(){
    $.get('https://20.206.250.122:5187/Disciplina/Listar')
...
function listarAvaliacaoPorDisciplina() {
    ...
    {
        $.get('https://20.206.250.122:5187/Avaliacao/ListarPorDisciplina?id=' + valueDiscipina)
            .done(function(resposta) { 
...
function deleteAvaliacao(id) {
    $.ajax({
        type: 'DELETE',
        url: 'https://20.206.250.122:5187/Avaliacao/Excluir',
...
function visualisarAvaliacao(id){
    $.get('https://20.206.250.122:5187/Avaliacao/Visualizar?id='+id)
    .done(function(resposta){
